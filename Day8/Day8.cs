...
namespace AdventOfCode
{
  public class Day8
  {
    ...
    public int Solve(int numberOfConnections, int numberOfMultiplications)
    {
      ...
      {
        //(int, int) reverseConn = new(distances[i].Item2.Item2, distances[i].Item2.Item1);
        //if (connections.Contains(distances[i].Item2) || connections.Contains(reverseConn))
        //{
        //  numberOfConnections++;
        //  continue;
        //}
      ...
      {
        _multiplicatonResult *= circuits[circuits.Count-i-1].Count;
      }
